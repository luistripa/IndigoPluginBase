...
class kDeviceAction(_enum.Enum):
    AllLightsOff = 1
    AllLightsOn = 2
    AllOff = 3
    BrightenBy = 4
...
class kVariableAction(_enum.Enum):
    DecrementValue = 1
    IncrementValue = 2
    SetValue = 3  # Set the value to the variableValue property


class kInstGroupCommand(_enum.Enum):
    Value = 1  # Description
...
class kSprinklerAction(_enum.Enum):
...
class kThermostatAction(_enum.Enum):
...
class kFanMode(_enum.Enum):
    AlwaysOn = 1
    Auto = 2


class kHvacMode(_enum.Enum):
    Cool = 1
    HeatCool = 2
    Heat = 3
    Off = 4
...
class kUniversalAction(_enum.Enum):
    Beep = 1
    EnergyUpdate = 2
    EnergyReset = 3
    RequestStatus = 4