...
from indigo._objects import Device, Variable, Trigger, DeviceAction
from indigo._utils import List
...
class PluginBase:
    ...
    def getDeviceStateList(self, dev: Device) -> List:
        """
    ...
    def getDeviceDisplayStateId(self, dev: Device) -> None:
        """
    ...
    def deviceStartComm(self, dev: Device) -> None:
        """
    ...
    def deviceStopComm(self, dev: Device) -> None:
        """
    ...
    def didDeviceCommPropertyChange(self, origDev: Device, newDev: Device) -> bool:
        """
        ...
        """
        return False  # TODO: Implement this method to support simulation
    ...
    def deviceDeleted(self, dev: Device) -> None:
        """
    ...
    def didTriggerProcessingPropertyChange(self, origTrigger: Trigger, newTrigger: Trigger) -> bool:
        """
    ...
    def variableCreated(self, var: Variable) -> None:
        """
    ...
    def variableUpdated(self, origVar: Variable, newVar: Variable) -> None:
        """
    ...
    def variableDeleted(self, var: Variable) -> None:
        """
    ...
    def actionControlDevice(self, action: DeviceAction):
        """
