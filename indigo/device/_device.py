...
from .._enums import *
import indigo._utils as _indigo_types
...
def allOff(selector: kAllDeviceSel = None):
    """
...
def create(address: str = "",
           ...
           protocol: kProtocol = kProtocol.Plugin,
           folder: int = 0) -> Device:
    """
...
def delete(device: Union[Device, int]) -> None:
    """
    Deletes the device.
...
def duplicate(device: Union[Device, int], duplicateName="") -> Device:
    """
...
def enable(device: Union[Device, int], value: bool = False) -> None:
    """
...
def getGroupList(device: Union[Device, int]) -> _indigo_types.List:
    """
    ...
    """
    return _indigo_types.List()  # TODO


def getDependencies(device: Union[Device, int]) -> _indigo_types.Dict:
    """
    ...
    """
    return _indigo_types.Dict()  # TODO


def moveToFolder(device: Union[Device, int], folder: Union[Folder, int]):
    """
...
def ping(device: Union[Device, int], suppressLogging: bool = False) -> bool:
    """
    Pings the device.
...
def removeDelayedActions(device: Union[Device, int]) -> None:
    """
...
def resetEnergyAccumTotal(device: Union[Device, int]) -> None:
    """
...
def displayInRemoteUI(device: Union[Device, int], value: bool = True) -> None:
    """
...
def statusRequest(device: Union[Device, int], suppressLogging: bool = False) -> None:
    """
...
def toggle(device: Union[Device, int], delay: int = -1, duration: int = -1) -> None:
    """
    Toggles the device.
...
def turnOff(device: Union[Device, int], delay: int = -1, duration: int = -1) -> None:
    """
...
def turnOn(device: Union[Device, int], delay: int = -1, duration: int = -1) -> None:
    """
    Turns on the device.
    Only works for devices that can be turned on and off.
...
def unlock(device: Union[Device, int], delay: int = -1, duration: int = -1) -> None:
    """
    Unlocks the device.
...
def lock(device: Union[Device, int], delay: int = -1, duration: int = -1) -> None:
    """
    Locks the device.
    Only works for devices that can be locked and unlocked.
