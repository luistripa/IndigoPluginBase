...
class DeviceAction(BaseAction):
    ...
    deviceAction: indigo.kDeviceAction
    """The command to send to the device"""

    actionValue: Union[int, Dict]
...
class ModifyVariableAction(BaseAction):
    ...
    variableAction: indigo.kVariableAction
...
class SendInsteonGroupCommandAction(BaseAction):
    command: indigo.kInstGroupCommand
...
class SprinklerAction(BaseAction):
    ...
    sprinklerAction: indigo.kSprinklerAction
    """The action to perform on the sprinkler device"""

    zoneDurations: List[float]
...
class ThermostatAction(BaseAction):
    ...
    thermostatAction: indigo.kThermostatAction
    """The action to perform on the thermostat device"""

    actionMode: Union[indigo.kFanMode, indigo.kHvacMode]
...
class UniversalAction(BaseAction):
    ...
    deviceAction: indigo.kUniversalAction
