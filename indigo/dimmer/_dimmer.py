"""Module that holds dimmer related functions."""

import typing as _typing

import indigo._objects as _objects
import indigo._enums as _enums
...
def allLightsOff(selector: _enums.kAllDeviceSel = None) -> None:
    """
...
def allLightsOn(selector: _enums.kAllDeviceSel = None) -> None:
    """
...
def brighten(device: _typing.Union[str, int, _objects.DimmerDevice], by: int = -1, delay: int = -1):
    """
...
def dim(device: _typing.Union[str, int, _objects.DimmerDevice], by: int = -1, delay: int = -1):
    """
...
def setBrightness(device: _typing.Union[str, int, _objects.DimmerDevice], value: int = 50, delay: int = -1):
    """
...
def setLedState(device: _typing.Union[str, int, _objects.DimmerDevice], index: int, value: bool, suppressLogging: bool = False, updateStatesOnly: bool = False):
    """
